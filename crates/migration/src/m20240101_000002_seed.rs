...
fn platform_menus() -> Vec<MenuSeed> {
    vec![
        (1, 0, "系统管理", 1, "/system", "", "", "", ""),
        (2, 1, "用户管理", 2, "/system/user", "system/user/index", "system:user:list", "/api/v1/users", "GET"),
        (3, 2, "用户新增", 3, "", "", "system:user:create", "/api/v1/users", "POST"),
        (4, 2, "用户修改", 3, "", "", "system:user:update", "/api/v1/users/:id", "PUT"),
        (5, 2, "用户删除", 3, "", "", "system:user:delete", "/api/v1/users/:id", "DELETE"),
        (6, 2, "分配角色", 3, "", "", "system:user:assign", "/api/v1/users/:id/roles", "PUT"),
        (10, 1, "角色管理", 2, "/system/role", "system/role/index", "system:role:list", "/api/v1/roles", "GET"),
        (11, 10, "角色新增", 3, "", "", "system:role:create", "/api/v1/roles", "POST"),
        (12, 10, "角色修改", 3, "", "", "system:role:update", "/api/v1/roles/:id", "PUT"),
        (13, 10, "角色删除", 3, "", "", "system:role:delete", "/api/v1/roles/:id", "DELETE"),
        (14, 10, "分配菜单", 3, "", "", "system:role:assign", "/api/v1/roles/:id/menus", "PUT"),
        (20, 1, "菜单管理", 2, "/system/menu", "system/menu/index", "system:menu:list", "/api/v1/menus", "GET"),
        (21, 20, "菜单新增", 3, "", "", "system:menu:create", "/api/v1/menus", "POST"),
        (22, 20, "菜单修改", 3, "", "", "system:menu:update", "/api/v1/menus/:id", "PUT"),
        (23, 20, "菜单删除", 3, "", "", "system:menu:delete", "/api/v1/menus/:id", "DELETE"),
        (30, 1, "操作日志", 2, "/system/log", "system/log/index", "system:log:list", "/api/v1/logs", "GET"),
        (40, 0, "租户管理", 2, "/platform/tenant", "platform/tenant/index", "platform:tenant:list", "/api/v1/platform/tenants", "GET"),
    ]
}
